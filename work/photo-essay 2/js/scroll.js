  // using d3 for convenience
        ...
        var graphic2 = container.select('.scroll__graphic');
        var text2 = container.select('.scroll__text');
        var step2 = text.selectAll('.step');
        ...
        function init() {
            ...
            scroller2.setup({
                container: '#scroll2',
                graphic: '#scroll2 .scroll__graphic',
                text: '#scroll2 .scroll__text',
                step: '#scroll2 .scroll__text .step',
                debug: false,
                offset: 0.33,
            })
